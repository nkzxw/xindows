...
//              
//----------------------------------------------------------------------------
CRegion& CRegion::operator=(const CRegion& rgn)
{
    if(IsComplex())
    {
        DiscardHRGN();
...
//              
//----------------------------------------------------------------------------
int CRegion::GetRegion(HRGN* prgn) const
{
    switch(_type)
    {
    case RGN_ERROR:
...
//              
//----------------------------------------------------------------------------
BOOL CRegion::operator==(const CRegion& rgn) const
{
    if(_type == rgn._type)
    {
        switch(_type)
...
//              
//----------------------------------------------------------------------------
void CRegion::IntersectComplex(const RECT& rc)
{
    if(_rc.IsEmpty())
    {
        DiscardHRGN();
...
//              
//----------------------------------------------------------------------------
void CRegion::Intersect(const CRegion& rgn)
{
    switch(rgn._type)
    {
    case RGN_ERROR:
...
//              
//----------------------------------------------------------------------------
void CRegion::Union(const RECT& rc)
{
    HRGN rgnTemp;
    CRect rcOld;
...
//              
//----------------------------------------------------------------------------
void CRegion::Union(const CRegion& rgn)
{
    switch(rgn._type)
    {
    case RGN_ERROR:
...
//              
//----------------------------------------------------------------------------
void CRegion::Subtract(const RECT& rc)
{
    HRGN rgnTemp;
...
//              
//----------------------------------------------------------------------------
void CRegion::Subtract(HRGN hrgn)
{
    Assert(hrgn != NULL);
...
//              
//----------------------------------------------------------------------------
void CRegion::Subtract(const CRegion& rgn)
{
    switch(rgn._type)
    {
    case RGN_ERROR:
...
//              
//----------------------------------------------------------------------------
BOOL CRegion::Intersects(HRGN rgn) const
{
    HRGN rgnIntersect;
    int result;
...
//              
//----------------------------------------------------------------------------
BOOL CRegion::Intersects(const CRegion& rgn) const
{
    switch(rgn._type)
    {
    case SIMPLEREGION:
...
//              
//----------------------------------------------------------------------------
CRegion::SUBTRACTRESULT CRegion::ResultOfSubtract(const CRegion& rgnSubtract) const
{
    if(IsComplex())
    {
        ...
        return (rgnSubtract._rc.Contains(_rc))?SUB_EMPTY:SUB_UNKNOWN;
    }

    if(rgnSubtract.IsComplex())
    {
        return (_rc.Intersects(rgnSubtract._rc))?SUB_UNKNOWN:SUB_RECTANGLE;
    }
    ...
    int cContainedCorners = rgnSubtract._rc.CountContainedCorners(_rc);
