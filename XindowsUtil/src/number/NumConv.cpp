...
//
//-----------------------------------------------------------------------
static TCHAR* RomanNumberHelper(LONG* pn, LONG nDivisor, TCHAR* szBuffer, TCHAR* szRomanLetter)
{
...
//
//-----------------------------------------------------------------------
static void RomanNumber(LONG n, TCHAR* szBuffer, TCHAR* achRomanChars)
{
...
//
//-----------------------------------------------------------------------
static void AlphaNumber(LONG n, TCHAR* szBuffer, TCHAR chBase)
{
    TCHAR* p = szBuffer;
