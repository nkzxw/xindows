...
#ifndef __XINDOWS_SITE_EDIT_EDCMD_H__
#define __XINDOWS_SITE_EDIT_EDCMD_H__
...
public:
    ...
    CCommand( DWORD cmdId, CXindowsEditor * pEd );
    ...
    // TODO : MOVE ALL OF THESE TO CXindowsEditor AS NON-STATIC, EXPOSE AS IHTMLEDITINGSERVICES
...
#endif //__XINDOWS_SITE_EDIT_EDCMD_H__
