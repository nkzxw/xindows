...
#ifndef __XINDOWS_SITE_EDIT_EDUTIL_H__
#define __XINDOWS_SITE_EDIT_EDUTIL_H__

class CSpringLoader;
class CSelectionManager;
class CXindowsEditor;

#define IFR(expr) {hr = expr; if (FAILED(hr)) RRETURN1(hr, S_FALSE);}
...
#endif //__XINDOWS_SITE_EDIT_EDUTIL_H__