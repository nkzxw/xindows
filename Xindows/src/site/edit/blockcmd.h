...
#ifndef __XINDOWS_SITE_EDIT_BLOCKCMD_H__
#define __XINDOWS_SITE_EDIT_BLOCKCMD_H__
...
{
public:
    CBlockPointer(CXindowsEditor *pEd);    
    ~CBlockPointer();    
...
public:
    ...
    CGetBlockFmtCommand(DWORD cmdId, CXindowsEditor * pEd)
    : CCommand(cmdId, pEd) 
    {
    }
...
public:
    ...
    CListCommand(DWORD cmdId, ELEMENT_TAG_ID tagId, CXindowsEditor * pEd )
...
public:
    ...
    CBlockFmtListCommand(DWORD cmdId, ELEMENT_TAG_ID tagId, CXindowsEditor * pEd )
...
public:
    ...
    CBlockFmtCommand(DWORD cmdId, ELEMENT_TAG_ID tagId, CXindowsEditor * pEd )
        : CBlockCommand(cmdId, pEd), _tagId(tagId)
    {
...
public:
    ...
    static HRESULT Set(REFIID iid, IUnknown *punk, BSTR szAlign)
    {
        ...
        hr = punk->QueryInterface(iid, (LPVOID *)&pT);
        if (SUCCEEDED(hr))
        {
...
#endif //__XINDOWS_SITE_EDIT_BLOCKCMD_H__