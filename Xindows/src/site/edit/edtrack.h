...
#ifndef __XINDOWS_SITE_EDIT_EDTRACK_H__
#define __XINDOWS_SITE_EDIT_EDTRACK_H__
...
CSelectTracker::MoveWord( IMarkupPointer* pPointer,
                          MOVEUNIT_ACTION  muAction)
{
    HRESULT hr = GetViewServices()->MoveWord( pPointer,
                                          muAction,
...
#endif //__XINDOWS_SITE_EDIT_EDTRACK_H__