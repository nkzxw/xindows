...
#ifndef __XINDOWS_SITE_TEXT_WCHDEFS_H__
#define __XINDOWS_SITE_TEXT_WCHDEFS_H__
...
{
#ifdef UNICODE
    return InRange(ch, WCH_HANGUL_START, WCH_HANGUL_END)||InRange(ch, WCH_JAMO_START, WCH_JAMO_END);
#else
    return FALSE;
#endif
}
...
// Lao
// Tibetan
BOOL inline IsComplexScriptChar(TCHAR ch)
{
...
// WCH_NADS
// WCH_NODS
inline BOOL IsFormattingControlChar(TCHAR ch)
{
...
// WCH_LRO
// WCH_RLO
inline BOOL IsBidiEmbeddingChar(TCHAR ch)
{
...
// WCH_ISS
// WCH_ASS
inline BOOL IsSymSwapControl(TCHAR ch)
{
...
// WCH_IAFS
// WCH_AAFS
inline BOOL IsArabicShapingControl(TCHAR ch)
{
...
// WCH_NADS
// WCH_NODS
inline BOOL IsDigitShapeControl(TCHAR ch)
{
...
inline BOOL IsSurrogateChar(TCHAR ch)
{
    return InRange(ch, WCH_UTF16_HIGH_FIRST, WCH_UTF16_LOW_LAST);
}

inline BOOL IsHighSurrogateChar(TCHAR ch)
{
    return InRange(ch, WCH_UTF16_HIGH_FIRST, WCH_UTF16_HIGH_LAST);
}

inline BOOL IsLowSurrogateChar(TCHAR ch)
{
    return InRange(ch, WCH_UTF16_LOW_FIRST, WCH_UTF16_LOW_LAST);

}

inline WCHAR HighSurrogateCharFromUcs4(DWORD ch)
{
    return 0xd800+((ch-0x10000)>>10);
}

inline WCHAR LowSurrogateCharFromUcs4(DWORD ch)
{
...
#endif //__XINDOWS_SITE_TEXT_WCHDEFS_H__