...
#ifndef __XINDOWS_SITE_DISPLAY_DISPDEFS_H__
#define __XINDOWS_SITE_DISPLAY_DISPDEFS_H__
...
// scroll directions
typedef enum tagSCROLL_DIRECTION
{
    SCROLL_UP     = 0x0001,
    SCROLL_DOWN   = 0x0002,
    SCROLL_LEFT   = 0x0004,
...
#endif //__XINDOWS_SITE_DISPLAY_DISPDEFS_H__